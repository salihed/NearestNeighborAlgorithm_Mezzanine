...
siparis_dosyasi = dosya_sec("Sipariş Dosyası:")
mezanin_stok_dosyasi = dosya_sec("Mezanin Stokları:")

siparis_df = pd.read_excel(siparis_dosyasi)
mezanin_df = pd.read_excel(mezanin_stok_dosyasi)
